<nav class="modulos">
    ...
    <div class="modulo laranja-escuro">
        ...
        <ul>
            ...
            <li>
                <a href="exercicio.php?dir=namespace&file=desafio_proprio">
                    Desafio Próprio
                </a>
            </li>
        </ul>
    ...
    <div class="modulo verde-escuro">
        ...
        <ul>
            ...
            <li>
                <a href="exercicio.php?dir=includes&file=desafio_resposta">
                    Desafio Includes
                </a>
            </li>
        </ul>
    ...
    <div class="modulo marrom">
        ...
        <ul>
            ...
            <li>
                <a href="exercicio.php?dir=classes_objetos&file=magic_methodes">
                    Métodos Mágicos
                </a>
            </li>
            <li>
    ...
    <div class="modulo azul">
        ...
        <ul>
            ...
            <li>
                <a href="exercicio.php?dir=variaveis&file=desafio">
                    Desafio Equação
                </a>
            </li>
            <li>
